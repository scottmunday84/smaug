...
/* for command types */
#define ML 	MAX_LEVEL	/* owner */
#define L1	MAX_LEVEL - 1  	/* implementor */
#define L2	MAX_LEVEL - 2	/* enforcer */
#define L3	MAX_LEVEL - 3	/* lead builder */
#define L4 	MAX_LEVEL - 4	/* head quest imm */
#define L5	MAX_LEVEL - 5	/* quality control */
#define L6	MAX_LEVEL - 6	/* builder */
#define L7	MAX_LEVEL - 7	/* quest imm */
#define L8	MAX_LEVEL - 8	/* trainee */
#define IM	LEVEL_IMMORTAL 	/* all immortals */
