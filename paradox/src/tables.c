...
const struct flag_type comm_flags[] =
{
    ...
    {   "noclangossip",		COMM_NOCGOSSIP,		TRUE	},
...
const struct flag_type apply_flags[] =
{
    ...
    {   "pstrength",		APPLY_STR_P,		FALSE	},
    {   "pdexterity",		APPLY_DEX_P,		FALSE	},
    {   "pintelligence",	APPLY_INT_P,		FALSE	},
    {	"pwisdom",		APPLY_WIS_P,		FALSE	},
    {	"pcondition",		APPLY_CON_P,		FALSE	},
    {	NULL,			0,			0	}
};
