...
bool spec_cast_adept( CHAR_DATA *ch )
{
	...
	spell_armor( skill_lookup( "immaterial armor" ), ch->level,ch,victim,TARGET_CHAR);
	return TRUE;
	...
	spell_cure_wounds( skill_lookup( "cure wounds" ),
	    ch->level, ch, victim,TARGET_CHAR);
	return TRUE;
	...
	spell_shield(skill_lookup("force shield"),
            ch->level,ch,victim,TARGET_CHAR); 
        return TRUE;
	...
	spell_heal(skill_lookup("heal"),
        ...
        return TRUE;
    case 10:
        act("$n utters the words 'gpaqtqwerty'.",ch,NULL,NULL,TO_ROOM);
        spell_shockshield(skill_lookup("shockshield"),
         ch->level,ch,victim,TARGET_CHAR);
        return TRUE;
    case 11:
        act("$n utters the words 'yucandusqwerty'.",ch,NULL,NULL,TO_ROOM);
        spell_fireshield(skill_lookup("fireshield"),
         ch->level,ch,victim,TARGET_CHAR);
        return TRUE;
    case 12:
        act("$n utters the words 'ouaih gfcandusiohp'.",ch,NULL,NULL,TO_ROOM);
        spell_vigor(skill_lookup("vigor"),
         ch->level,ch,victim,TARGET_CHAR);
        return TRUE;
    case 13:
        act("$n utters the words 'qfuweryed'.",ch,NULL,NULL,TO_ROOM);
        spell_mastermind(skill_lookup("mastermind"),
         ch->level,ch,victim,TARGET_CHAR); 
        return TRUE;
    }
...
bool spec_cast_clan_adept( CHAR_DATA *ch )
{
    ...
    case 0:
	act( "$n utters the word 'abrazak'.", ch, NULL, NULL, TO_ROOM );
	spell_armor( skill_lookup( "immaterial armor" ), ch->level/2,ch,victim,TARGET_CHAR);
	return TRUE;
...
bool spec_cast_cleric( CHAR_DATA *ch )
{
	...
	case  1: min_level =  3; spell = "cause damage";  break;
	case  2: min_level =  7; spell = "earthquake";     break;
	case  3: min_level =  9; spell = "cause damage"; break;
	case  4: min_level = 10; spell = "cascade";    break;
	case  5: min_level = 12; spell = "curse";          break;
	case  6: min_level = 13; spell = "sandstorm";	   break;
	case  7: min_level = 13; spell = "elemental fury";    break;
	case  8:
	case  9: min_level =  0; spell = "poison";		break;
	case 10: min_level = 15; spell = "cause damage";           break;
...
bool spec_cast_mage( CHAR_DATA *ch )
{
	...
	case  4: min_level = 11; spell = "sandstorm";   break;
	case  5: min_level = 12; spell = "poison";     break;
	case  6: min_level = 13; spell = "energy drain";   break;
	case  7:
	case  8:
	case  9: min_level = 15; spell = "cause damage";       break;
...
bool spec_cast_undead( CHAR_DATA *ch )
{
	...
	case  2: min_level =  6; spell = "acid blast";    break;
	case  3: min_level =  9; spell = "blindness";      break;
	case  4: min_level = 12; spell = "poison";         break;
	case  5: min_level = 15; spell = "energy drain";   break;
	case  6: min_level = 18; spell = "cause damage";           break;
	case  7: min_level = 21; spell = "teleport";       break;
	case  8: min_level = 20; spell = "plague";	   break;
	default: min_level = 18; spell = "bloodbath";           break;
	}
