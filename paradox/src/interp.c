...
const	struct	cmd_type	cmd_table	[] =
{
     ...
     */
    { "at",             do_at,          POS_DEAD,       L5,  1,  LOG_NORMAL, 1 },
...
/*  { "groups",		do_groups,	POS_SLEEPING,	 0,  1,  LOG_NORMAL, 1 }, */
    ...
    { "recent",		do_recent,	POS_DEAD,	 0,  1,  LOG_NORMAL, 1 },
    { "rank",		do_rank,	POS_DEAD,	 0,  1,  LOG_NORMAL, 1 },
    { "whois",		do_whois,	POS_DEAD,	 0,  1,  LOG_NORMAL, 1 },
    { "bounty",		do_bounty,	POS_DEAD,	 0,  1,  LOG_NORMAL, 1 },	
    ...
    { "suppress",	do_suppress,	POS_DEAD,	 0,  1,  LOG_NORMAL, 1 },
...
/*  { "channels",	do_channels,	POS_DEAD,	 0,  1,  LOG_NORMAL, 1 }, */
    ...
    { "crecover",	do_crecover,	POS_RESTING,	 0,  1,  LOG_NORMAL, 1 },
    { "pmote",		do_pmote,	POS_RESTING,	 0,  1,  LOG_NORMAL, 1 },
/*    { ".",		do_flame,	POS_SLEEPING,	 0,  1,  LOG_NORMAL, 0 },*/
...
/*    { "shout",		do_shout,	POS_RESTING,	 3,  1,  LOG_NORMAL, 1 },*/
    ...
    { "claninfo",	do_claninfo,	POS_SLEEPING,	 0,  1,  LOG_NORMAL, 1 },
...
/*  { "unlock",		do_unlock,	POS_RESTING,	 0,  1,  LOG_NORMAL, 1 }, */
    ...
    { "charge",		do_charge,	POS_FIGHTING,	 0,  1,  LOG_NORMAL, 1 },
...
/*    { "murde",		do_murde,	POS_FIGHTING,	 0,  1,  LOG_NORMAL, 0 },
    ...
    { "earthbind",	do_earthbind,	POS_FIGHTING,	 0,  1,  LOG_NORMAL, 1 },
    /*
...
/*  { "group",		do_group,	POS_SLEEPING,	 0,  1,  LOG_NORMAL, 1 }, */
    ...
    { "search",		do_search,	POS_RESTING,	 0,  1,  LOG_NORMAL, 1 },
    { "forage",		do_forage,	POS_RESTING,	 0,  1,  LOG_NORMAL, 1 },
...
/*  { "practice",	do_practice,	POS_SLEEPING,	 0,  1,  LOG_NORMAL, 1 }, */
    ...
    { "shadow walk",	do_shadow_walk,	POS_STANDING,	 0,  1,  LOG_NORMAL, 1 },
    ...
    { "revert",		do_revert,	POS_STANDING,	 0,  1,  LOG_NORMAL, 1 },
    ...
    { "view",		do_view,	POS_SLEEPING,	 0,  1,	 LOG_NORMAL, 1 },
    ...
    { "arese",		do_arese,	POS_DEAD,	L2,  1,	 LOG_ALWAYS, 0 },
    { "areset",		do_areset,	POS_DEAD,	L2,  1,  LOG_ALWAYS, 1 },
    { "crash",		do_crash,	POS_DEAD,	ML,  1,	 LOG_ALWAYS, 1 },
    { "avatar",		do_avatar,	POS_DEAD,	L7,  1,  LOG_ALWAYS, 1 },
    { "dump",		do_dump,	POS_DEAD,	L1,  1,  LOG_ALWAYS, 0 },
    { "trust",		do_trust,	POS_DEAD,	L1,  1,  LOG_ALWAYS, 1 },
    { "violate",	do_violate,	POS_DEAD,	L1,  1,  LOG_ALWAYS, 1 },
    { "copyove",	do_copyove,	POS_DEAD,	L1,  1,  LOG_ALWAYS, 1 },
    { "copyover",	do_copyover,	POS_DEAD,	L1,  1,  LOG_ALWAYS, 1 },
    { "check",		do_check,	POS_DEAD,	ML,  1,	 LOG_ALWAYS, 1 },
    { "addallow",	do_addallow,	POS_DEAD,	ML,  1,  LOG_ALWAYS, 1 },
    ...
    { "finger",		do_whois,	POS_DEAD,	 0,  1,  LOG_NORMAL, 1 },
    { "flag",		do_flag,	POS_DEAD,	L1,  1,  LOG_ALWAYS, 1 },
    { "freeze",		do_freeze,	POS_DEAD,	L4,  1,  LOG_ALWAYS, 1 },
    { "confiscate",	do_confiscate,	POS_DEAD,	L5,  1,  LOG_ALWAYS, 1 },
...
/*    { "wedpost",	do_wedpost,	POS_DEAD,	ML,  1,  LOG_NORMAL, 1 },*/
    ...
    { "nochannels",	do_nochannels,	POS_DEAD,	L5,  1,  LOG_ALWAYS, 1 },
    { "noemote",	do_noemote,	POS_DEAD,	L5,  1,  LOG_ALWAYS, 1 },
    { "noclan",		do_noclan,	POS_DEAD,	L2,  1,  LOG_ALWAYS, 1 },
    { "norestore",	do_norestore,	POS_DEAD,	L2,  1,  LOG_ALWAYS, 1 },
    { "noshout",	do_noshout,	POS_DEAD,	L5,  1,  LOG_ALWAYS, 1 },
    { "notell",		do_notell,	POS_DEAD,	L2,  1,  LOG_ALWAYS, 1 },
    { "notitle",	do_notitle,	POS_DEAD,	L2,  1,  LOG_ALWAYS, 1 },
    { "pack",		do_pack,	POS_DEAD,       IM,  1,  LOG_NORMAL, 1 },
    { "pecho",		do_pecho,	POS_DEAD,	L4,  1,  LOG_NORMAL, 1 }, 
    { "purge",		do_purge,	POS_DEAD,	IM,  1,  LOG_NORMAL, 1 },
    { "restore",	do_restore,	POS_DEAD,	L7,  1,  LOG_NORMAL, 1 },
    { "sla",		do_sla,		POS_DEAD,	L2,  1,  LOG_NORMAL, 0 },
    { "slay",		do_slay,	POS_DEAD,	L2,  1,  LOG_NORMAL, 1 },
    { "teleport",	do_transfer,    POS_DEAD,	L7,  1,  LOG_NORMAL, 1 },	
    { "iflag",		do_iflag,	POS_DEAD,	IM,  1,  LOG_NORMAL, 1 },
    { "transfer",	do_transfer,	POS_DEAD,	L7,  1,  LOG_NORMAL, 1 },
    { "corner",		do_corner,	POS_DEAD,	L7,  1,  LOG_ALWAYS, 1 },
    { "twit",		do_twit,	POS_DEAD,	L2,  1,  LOG_NORMAL, 1 },
    { "pardon",		do_pardon,	POS_DEAD,	L2,  1,  LOG_NORMAL, 1 },

/*  { "at",		do_at,		POS_DEAD,	L6,  1,  LOG_NORMAL, 1 }, */
    { "poofin",		do_bamfin,	POS_DEAD,	L7,  1,  LOG_NORMAL, 1 },
    { "poofout",	do_bamfout,	POS_DEAD,	L7,  1,  LOG_NORMAL, 1 },
...
/*  { "goto",		do_goto,	POS_DEAD,	L8,  1,  LOG_NORMAL, 1 }, */
    ...
    { "allpeace",	do_allpeace,	POS_DEAD,	L2,  1,  LOG_NORMAL, 1 },
    { "penalty",	do_penalty,	POS_DEAD,	IM,  1,  LOG_NORMAL, 1 },
    { "echo",		do_recho,	POS_DEAD,	L7,  1,  LOG_NORMAL, 1 },
    { "return",         do_return,      POS_DEAD,       L4,  1,  LOG_NORMAL, 1 },
    { "snoop",		do_snoop,	POS_DEAD,	L2,  1,  LOG_ALWAYS, 1 },
    { "stat",		do_stat,	POS_DEAD,	IM,  1,  LOG_NORMAL, 1 },
    { "string",		do_string,	POS_DEAD,	L5,  1,  LOG_NORMAL, 1 },
    { "switch",		do_switch,	POS_DEAD,	L4,  1,  LOG_NORMAL, 1 },
    ...
    { "clead",		do_clead,	POS_DEAD,	L2,  1,  LOG_NORMAL, 1 },

    { "clone",		do_clone,	POS_DEAD,	L5,  1,  LOG_NORMAL, 1 },
    ...
    { "mpoint",		do_mpoint,	POS_DEAD,	L4,  1,  LOG_NORMAL, 1 },
    { "mquest",		do_mquest,	POS_DEAD,	L4,  1,  LOG_NORMAL, 1 },
/*    { "randclan",	do_randclan,	POS_DEAD,	ML,  1,  LOG_NORMAL, 1 },*/
    { "sign",		do_sign,	POS_DEAD,	L7,  1,  LOG_NORMAL, 1 },
/*    { "immkiss",	do_immkiss,	POS_DEAD,	L4,  1,  LOG_NORMAL, 1 },
    ...
    { "wizslap",	do_wizslap,	POS_DEAD,	L4,  1,  LOG_NORMAL, 1 },
